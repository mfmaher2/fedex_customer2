...
public class KeyspaceConfigMultiDC extends KeyspaceConfig{
    ...
    protected void AssignKeyspaceNames(){
        ...
        keyspaceNames.put(Keyspace.CAM_OPERATIONS, "cam_operations_ks");
    ...
    protected void AssignDataCenterMappings(){
        ...
        AddKeyspaceDataCenter(Keyspace.CAM_OPERATIONS, datacenters.get(DataCenter.CORE), 1);
        ...
        AddKeyspaceDataCenter(Keyspace.CAM_OPERATIONS, datacenters.get(DataCenter.SEARCH), 1);
