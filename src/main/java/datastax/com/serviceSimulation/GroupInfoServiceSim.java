...
public class GroupInfoServiceSim {

    static private final String TABLE_NAME = "group_info_v1";
    static private final String SERVICE_NAME = "GroupInfoService";
    ...
    public static boolean updateAccountEnterpriseSource(UUID transactionID, String accountNum, String opco, String newEntSource, ServiceEnvironmentDetails envDetails){
        ...
        GroupInfo updatedAccount = new GroupInfo();
...
//        updatedAccount.setProfileEnterpriseSource(newEntSource);
        ...
        GroupInfo existingRecord = envDetails.daoGroupInfo.findByAccountNumberOpco(accountNum, opco);
