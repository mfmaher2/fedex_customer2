...
CREATE TABLE IF NOT EXISTS @datastax_app_name@_payment_info@datastax_app_level@ks.payment_info_v1 (
    ...
    -- IBAN AND NON IBAN COMMON . Updating from direct debit detail to general
    iban__swift_code text,
    iban_iban text,
    non_iban__bank_code text,
    non_iban__branch_code text,
    dnon_iban__account_number text,
    non_iban__sort_code text,
    ...
    -- ElectronicPay Credit Card Person And Address
    electronicPayCreditCard__person__first_name text,
    electronicPayCreditCard__person__last_name text,
    electronicPayCreditCard__person__middle_name text,
    electronicPayCreditCard__person__prefix text,
    electronicPayCreditCard__person__suffix text,
    electronicPayCreditCard__person__title text,
    electronicPayCreditCard__person__gender text,
    electronicPayCreditCard__address__street_line text,
    electronicPayCreditCard__address__additional_line1 text,
    electronicPayCreditCard__address__additional_line2 text,
    electronicPayCreditCard__address__secondary__unit1 text,
    electronicPayCreditCard__address__secondary__value1 text,
    electronicPayCreditCard__address__secondary__unit2 text,
    electronicPayCreditCard__address__secondary__value2 text,
    electronicPayCreditCard__address__secondary__unit3 text,
    electronicPayCreditCard__address__secondary__value3 text,
    electronicPayCreditCard__address__secondary__unit4 text,
    electronicPayCreditCard__address__secondary__value4 text,
    electronicPayCreditCard__address__geo_political_subdivision1 text,
    electronicPayCreditCard__address__geo_political_subdivision2 text,
    electronicPayCreditCard__address__geo_political_subdivision3 text,
    electronicPayCreditCard__address__postal_code text,
    electronicPayCreditCard__address__country_code text,
